...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 26, 2023 lúc 09:31 AM
...
--
-- Đang đổ dữ liệu cho bảng `assign_task`
--
...
(1020, '1058', '2023-03-23', '08:30:00', '05:30:00', '03 h 0 m', 'field', NULL, NULL, NULL, 'A');
...
(2, 'Joh1474', 'Suspension', 'Test Test Test', '');
...
(10, 'Soy1332', '99', 0, 0, 'Monoban', 'LaLisa', 'lalisa@mail.com', 'a5900fdc0330ea138339bfcc4e9134be1eb8fac5', 'SUPER ADMIN', NULL, 'ACTIVE', 'Female', '7856587870', '1985-12-05', 'B+', '2018-01-06', '2018-01-06', 'Soy13322.jpg', '132154566556'),
...
(39, 'Rob1472', '1058', 5, 5, 'Park', 'Jimin', 'jimin@mail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'EMPLOYEE', NULL, 'ACTIVE', 'Female', '7850001111', '1992-12-24', 'A+', '2021-04-14', '', 'Rob14721.jpg', '7000105000'),
...
(41, 'Smi1266', '3008', 8, 8, 'Lee', 'MinHo', 'leeminho@mail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'EMPLOYEE', NULL, 'ACTIVE', 'Male', '7400001450', '1990-12-12', 'B+', '2021-10-10', '', 'Smi1266.jpg', '0147000000'),
...
(43, 'Joh1474', '8829', 7, 7, 'Michael', 'Johnson', 'michael@mail.com', 'd492ed1b1fdfbc9ca9db7c10c7df38d2b488fb14', 'EMPLOYEE', NULL, 'INACTIVE', 'Male', '7801450000', '1986-02-23', 'B-', '2021-02-02', '', 'Joh1474.png', '600254000014'),
(44, 'Den1745', '6600', 7, 7, 'Jisoo', 'BlackPink', 'jisoo@mail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'EMPLOYEE', NULL, 'ACTIVE', 'Female', '7410144470', '1996-03-03', 'AB+', '2021-10-10', '', 'Den1745.png', '880024520000');
...
(1, 'Giao thừa', '2021-12-30', '2022-01-31', '32', '12-2021'),
(3, 'Năm mới', '2022-01-01', '2022-01-02', '1', '01-2022'),
(5, 'Giáng Sinh', '2021-12-23', '2021-12-25', '2', '12-2021'),
(6, 'lễ tạ ơn', '2021-11-23', '2021-11-26', '3', '11-2021'),
(7, 'Halloween', '2021-10-31', '2021-10-31', '0', '10-2021'),
(8, 'Quốc Khánh', '2021-04-30', '2021-05-01', '0', '03-2021');
...
--
-- Đang đổ dữ liệu cho bảng `pay_salary`
--
...
(7, 'Moo1634', 0, 'January', '2023', '2023-04-12', '', '8600', NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', 0, 8600, 'Paid', 'Hand Cash');
...
(4, 'Hoạt động dịch vụ hỗ trợ khách hàng', '04/12/2023', '03/29/2023', 'Bạn được yêu cầu phát triển hoạt động dựa trên dịch vụ hỗ trợ khách hàng bằng DotNet (.Net)', 'Phát triển hoạt động dịch vụ hỗ trợ khách hàng', 'running', NULL),
...
(6, 'đồ họa minh họa', '04/05/2023', '04/21/2023', 'You are required to make a graphic illustration for XYZ company. ', 'Make a graphic illustration for ....', 'running', NULL);
...
--
-- Đang đổ dữ liệu cho bảng `pro_task`
--
...
(1, 'FSI_(1)1.png', 'FSI VietNam', 'Chỉ là một mô tả demo và không có gì khác!', 'Cao Thế Dũng', '0001110000', 'VND', '$', 'exemple@gmail.com', 'hà nội', 'Cầu Giấy');
...
(6, 'Soy1332', 'Test Phần Mềm', '2023-04-26 01:21:49pm', '1');
