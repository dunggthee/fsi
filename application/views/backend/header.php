...
<head>
    ...
    <meta name="author" content="Dope developers">
    <!-- Favicon icon -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
                        <img src="<?php echo base_url();?>assets/images/logo1.png" alt="DRI" class="DRI-logo" style="width:50px;"/>
                        </b>
                        <!-- Logo text --><span>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox scale-up-left">
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="javascript:void(0);"> <strong>Xem Tất Cả Thông Báo</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>"><i class="ti-user"></i> Hồ Sơ</a></li>
